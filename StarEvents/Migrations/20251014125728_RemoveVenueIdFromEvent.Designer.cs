...
namespace StarEvents.Migrations
{
    ...
    [Migration("20251014125728_RemoveVenueIdFromEvent")]
    partial class RemoveVenueIdFromEvent
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StarEvents.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("StarEvents.Models.SystemSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("EmailForPromotions")
                        .HasColumnType("bit");

                    b.Property<bool>("EmailOnBookingConfirmation")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("EnableQRCodeTickets")
                        .HasColumnType("bit");
                    ...
                    b.Property<int>("PointsPer100LKR")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("StarEvents.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("StarEvents.Models.Booking", b =>
                {
                    b.HasOne("StarEvents.Models.ApplicationUser", "Customer")
                        .WithMany("Bookings")
            ...
            modelBuilder.Entity("StarEvents.Models.Event", b =>
                {
                    b.HasOne("StarEvents.Models.ApplicationUser", "Organizer")
